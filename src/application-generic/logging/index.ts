...
import { LoggerErrorInterceptor, Logger, LoggerModule, PinoLogger, getLoggerToken } from 'nestjs-pino';
...
export function createNestLoggingModuleOptions(settings: ILoggerSettings) {
  ...
  // eslint-disable-next-line no-console
  console.log('Selected Log Transport ' + (!transport ? 'None' : 'pino-pretty'));
