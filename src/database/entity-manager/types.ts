...
export interface EntityManager {
  ...
  attachRelations(uid: string, id: ID, data: any, options?: { transaction?: Knex.Transaction }): Promise<any>;
  updateRelations(uid: string, id: ID, data: any, options?: { transaction?: Knex.Transaction }): Promise<any>;
