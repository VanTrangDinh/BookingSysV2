...
// const withOffsetLimit = (params: Params): [ParamsWithLimits, { page: number; pageSize: number }] => {
...
//       return Promise.all([db.entityManager.findMany(uid, params), db.entityManager.count(uid, params)]);
//     },
